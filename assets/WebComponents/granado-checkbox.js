...
class GranadoCheckbox extends HTMLElement {
  ...
  _build() {
    ...
    this.innerHTML = `
      <span data-cb-root role="checkbox" tabindex="0" style="display:inline-flex;align-items:center;gap:8px;user-select:none;font-family:system-ui,-apple-system,sans-serif;font-size:13px;outline:none;line-height:1">
