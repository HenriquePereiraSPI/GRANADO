...
class GranadoToast extends HTMLElement {
  ...
  _render() {
    ...
    this.innerHTML = `
      <div data-toast-card style="display:flex;align-items:flex-start;gap:12px;background:#FDFAF1;border:1px solid #E5DDC8;border-left:4px solid ${color};border-radius:8px;padding:12px 14px;box-shadow:0 6px 20px rgba(0,0,0,0.16);font-family:system-ui,-apple-system,sans-serif;min-width:280px;max-width:380px;pointer-events:auto;box-sizing:border-box">
