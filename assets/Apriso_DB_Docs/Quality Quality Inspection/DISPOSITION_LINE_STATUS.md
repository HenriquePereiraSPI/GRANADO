# DISPOSITION_LINE_STATUS

**Database:** Operational

**Description:** Contains all system statuses of the Disposition Line (DISPOSITION_LINE)
...
| Status | SMALLINT(5,0) | False |  | True |  | Status of the Disposition Line. |
| TextID | INT(10,0) | True |  | False |  | Unique identifier of the Text. Can be used for translation purposes. |

## Primary Key

- **PK_DISPOSITION_LINE_STATUS** on `Status`
...
- **UK_DISPOSITION_LINE_STATUS** on `Name`

## Non-Unique Indexes

- **IF_DISPOSITION_LINE_STATUS_DISPOSITION_USER_STATUS** on `DispositionUserStatusID`
