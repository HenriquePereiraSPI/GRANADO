...
**Description:** Specification of data collects linked to WIP.
...
| DataType | INT(10,0) | False |  | False |  | Data type of the Data Collect. It can be: 1 - String, 2 - Integer, 3 - Real, 4 - Boolean, 5 - DateTime. |
...
| WipDataCollectPlanID | INT(10,0) | False |  | False | WIP_DATA_COLLECT_PLAN | Unique identifier of the WIP Data Collect Plan. |

## Primary Key

- **PK_WIP_DATA_COLLECT** on `ID`
...
- **IF_WIP_DATA_COLLECT_DSID** on `DSID`
- **IF_WIP_DATA_COLLECT_PROCESS_DATA_COLLECT** on `ProcessDataCollectID`
- **IF_WIP_DATA_COLLECT_UNIT** on `UnitID`
- **IF_WIP_DATA_COLLECT_WIP_DATA_COLLECT_PLAN** on `WipDataCollectPlanID`
