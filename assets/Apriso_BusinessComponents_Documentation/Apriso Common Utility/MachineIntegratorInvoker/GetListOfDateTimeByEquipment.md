...
The purpose of this Business Component method is to get the value (List of DateTime type) of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Output | Value | ListofDateTime | No | The Value retrieved from the machine Point. |
...
- The Equipment and Feature assignment to the Machine Integrtor Point is validated and if not found, the "ErrorUnknownAlias" ErrorCode is set 
