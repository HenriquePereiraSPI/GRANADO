...
|----|------|------|----------|-------------|
| Input | ItemAlias | Char | Yes | The machine full point aliase in the following format: [connector]\[data_source]\[point_group]\[point] |
| Input | Value | Integer | Yes | Value to be set on the machine point. |
