...
The purpose of this Business Component method is to set a value (of the List of Bool type) of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Input | Value | ListofBool | Yes | The value to be set on the machine Point. |
