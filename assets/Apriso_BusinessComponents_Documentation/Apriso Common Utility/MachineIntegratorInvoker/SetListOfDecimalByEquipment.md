...
The purpose of this Business Component method is to set a value (of the List of Decimal type) of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Input | Value | ListofDecimal | Yes | The value to be set on the machine Point. |
...
- In case of a communication error or no connection to the Machine Integrator Connector, the "NoConnection" ErrorCode is set 
