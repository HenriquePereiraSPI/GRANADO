...
The purpose of this Business Component method is to get the Boolean value of the Machine Integrator Point assigned to the specific Equipment's Feature.
...
| Output | Value | Boolean | No | Value retrieved from the machine Point. |
