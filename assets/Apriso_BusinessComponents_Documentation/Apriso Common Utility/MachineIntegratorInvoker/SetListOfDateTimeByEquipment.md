...
The purpose of this Business Component method is to set a value (of the List of DateTime type) of the Machine Integrator Point assigned to a specific Equipment's Features.
...
| Input | Value | ListofDateTime | Yes | The value to be set on the machine Point. |
