...
The purpose of this Business Component method is to set a value (of the Char type) of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Input | Value | Char | Yes | The value to be set on the machine Point. |
...
- If no providers are found for thje requested items or an exception occurs, the error message is displayed
