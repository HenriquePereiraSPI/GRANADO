...
The purpose of this Business Component method is to get the DateTime value of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Output | Value | DateTime | No | The value retrieved from the machine Point. |
...
- If an assigned Point has a different type than expected, then the "ErrorBadType" ErrorCode is set 
