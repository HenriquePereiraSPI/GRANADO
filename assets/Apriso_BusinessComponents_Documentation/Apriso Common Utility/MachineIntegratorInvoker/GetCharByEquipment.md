...
The purpose of this Business Component method is to get the Char value of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Output | Value | Char | No | The value retrieved from the machine Point. |
