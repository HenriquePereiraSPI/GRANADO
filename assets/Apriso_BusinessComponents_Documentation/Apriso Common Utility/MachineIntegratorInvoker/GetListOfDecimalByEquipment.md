...
The purpose of this Business Component method is to get the value (List of Decimal type) of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Output | Value | ListofDecimal | No | The value retrieved from the machine Point. |
