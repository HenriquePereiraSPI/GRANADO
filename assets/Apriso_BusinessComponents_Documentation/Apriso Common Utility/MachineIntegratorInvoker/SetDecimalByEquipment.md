...
The purpose of this Business Component method is to set a Decimal value of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Input | Value | Decimal | Yes | The value to be set on the machine Point. |
