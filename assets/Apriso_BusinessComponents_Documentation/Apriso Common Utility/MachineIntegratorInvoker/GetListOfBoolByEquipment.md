...
The purpose of this Business Component method is to get the value (List of Boolean type) of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Output | Value | ListofBool | No | The value retrieved from the machine Point. |
