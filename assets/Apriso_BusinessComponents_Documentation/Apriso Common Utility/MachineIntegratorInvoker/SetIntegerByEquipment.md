...
The purpose of this Business Component method is to set an Integer value of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Input | Value | Integer | Yes | The value to be set on the machine Point. |
