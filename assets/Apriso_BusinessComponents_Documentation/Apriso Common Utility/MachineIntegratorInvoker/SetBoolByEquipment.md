...
The purpose of this Business Component method is to set a Boolean value of the Machine Integrator Point assigned to a specific Equipment's Feature.
...
| Input | Value | Boolean | Yes | The value to be set on the Machine Point. |
