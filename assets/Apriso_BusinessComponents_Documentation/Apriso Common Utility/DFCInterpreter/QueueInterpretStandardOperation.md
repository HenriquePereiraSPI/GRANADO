...
Schedules in JobExecutor invocation (execution) of specified standard operation. The first input is the ID of the standard operation to schedule and the second is a list of the inputs in format Input1Name|Input1Value#Input2Name|Input2Value.
...
System schedules in JobExecutor invocation of the standard operation.
