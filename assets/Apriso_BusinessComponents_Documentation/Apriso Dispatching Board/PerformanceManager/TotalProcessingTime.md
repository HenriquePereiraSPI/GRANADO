...
This Business Component gets the total processing time in hours.
...
- Validates if the "TotalProcessingTime" Performance Class exists

## System Processing

- The system iterates through all of the activities in the Workspace  
- The system sums up the duration in hours of all of the activities  
- The system updates the performance value with the total processing time in hours of the Workspace
