...
The purpose of this Business Component method is to delete an existing record in the CAPA_STEP_STATE table.
...
- The system deletes the record from the CAPA_STEP_STATE table. 
