# CreateAllChangesPackageFromProject
...
Creates a package that contains only the items that have been changed or added since the Generate Everything option was used.
...
- System prepares Package Creation request from Project with a given name and revision. 
- GenerationComments and TrackingReference Inputs are populated on request. 
...
- Creation of the Package is asynchronous, and to see creation result you need to go to Global Process Manager. 
- Package will contain only the items that have been changed or added since the Generate Everything option was used.
