# CreateLatestChangesPackageFromProject
...
Creates a package that contains only items that have been changed or added since the last package generation.
...
- Project definition will be included in the generated package if the IncludeProjectDefition is selected. 
...
- Package will contain only items that have been changed or added since the last package generation.
