...
A record is inserted in CONTAINMENT_SERIAL_NO if the validation succeeds.

## Pre-Conditions

Pre-condition: the Containment and Serial Number must exist. Post-condition: the Serial Number added to Containment.
