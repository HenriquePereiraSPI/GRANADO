...
| Input | RoleID | Integer | Yes | The Role ID for which the check will be performed. |
| Input | HasRole | Boolean | Yes | This is True if the employee has the Role. Otherwise, this is False. |
...
- The system returns True if the employee has the Role. Otherwise, the system returns False.
