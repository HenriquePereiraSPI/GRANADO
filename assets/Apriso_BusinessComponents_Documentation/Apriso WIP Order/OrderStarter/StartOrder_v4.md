...
| Output | ResourceLaborIDList | List of Integer | No | The ID of the created RESOURCE LABOR record. |
...
- The system populates the WorkCenter for the labor record by first checking the WIP Operation and then the employee Facility 
...
TRANSACTION_HISTORY - Transaction Name: FlexNet.BusinessFacade.Manufacturing.OrderStarter.StartOrder TRANSACTION_HISTORY_WIP TRANSACTION_HISTORY_RESOURCE
