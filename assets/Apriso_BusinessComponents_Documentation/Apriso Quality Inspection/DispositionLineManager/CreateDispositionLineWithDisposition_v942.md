# CreateDispositionLineWithDisposition_v942
...
Method is used to simplify the process of creating the single Disposition Line by wrapping two other BC methods: Create Quality Disposition, Create Disposition Line. The difference between CreateDispositionLineWithDisposition_v941 is that SamplingProcedureID replaces SamplePlanID and Work Center input is added.
...
| Input | SamplingProcedureID | Integer | No | Link to sampling procedure to be used to calculate Sample Size |
...
- SamplingProcedureID when specified exists in SAMPLING_PROCEDURE table. 
- WorkCenter when specified exists in WORK_CENTER table. 
- SamplingProcedureID will be persisted in DISPOSITION_LINE and DISPOSITION table. 
- WorkCenter will be persisted in DISPOSITION_LINE table. 
...
- Invokes Create Disposition v942 BC 
- Invokes Create Disposition Line v942 passing DispositionCreated as Disposition parameter.
...
| [All tables populated by Create Disposition v942 BC method] |  |  |
| [All tables populated by Create Disposition Line v942 BC method] |  |  |
