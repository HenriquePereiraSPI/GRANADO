...
This Business Component method is used to create Disposition record that represents the header of the Quality Inspection. The difference between this BC method and CreateDispositon_942 is that it has two additional inputs: QualityGateID and QualityGateSeqItemID.
