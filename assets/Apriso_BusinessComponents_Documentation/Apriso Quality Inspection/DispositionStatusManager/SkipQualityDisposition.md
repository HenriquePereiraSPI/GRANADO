...
- See documentation for SkipQualityDisposition_v94.

## System Processing

- Invokes SkipQualityDisposition_v94 passing all the parameters and number of 0 for EmployeeID (that means that EmployeeID is not specified).
