...
The method is used to validate and change the status of the Disposition Test or Disposition Test Sample to Started.
...
- See documentation for StartDispositionTest_v94.

## System Processing

- Invokes StartDispositionTest_v94 passing all the parameters and number of 0 for EmployeeID (that means that EmployeeID is not specified).
