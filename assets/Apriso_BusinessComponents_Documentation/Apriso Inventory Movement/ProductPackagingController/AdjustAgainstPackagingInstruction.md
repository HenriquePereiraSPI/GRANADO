# AdjustAgainstPackagingInstruction
...
This Business Component is used to generate an inventory adjustment with reference to a packaging instruction (PI). It is a combination of the Adjust BC and the DecomposePackagingInstr BC. It supports the fact that the main packaging element of the level 1 can be serialized.
...
| Input | Quantity | Decimal | Yes | The quantity of the product to be generated. |
...
- Special case 2: packaging material is not managed in inventory: 
 
- The system creates/adjusts the packaging material in the Warehouse location provided by WarehouseLocationID. 
 
- Special case 3: packaging material is returnable: 
...
- Special case 4: packaging material is non-returnable: 
 
- The system validates that the packaging material exists in the location provided by WarehouseLocationID for the partner given by PartnerID. 
- The system moves the packaging material to the Container.
