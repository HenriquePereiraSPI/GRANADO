# RetrievePackagingInstruction_v2
...
| Input | NumberOfRequestedPI | Decimal | Yes | Number of requested packaging instructions to retrieve. If 0, all packaging instructions will be retrieved. |
...
| Output | ReportFUIDLevel1 | Char | No | Array of report FUIDs on level 1 |
...
| Output | ReportFUIDLevel2 | Char | No | Array of report FUIDs on level 2 |
| Output | ReportIDLevel1 | Integer | No | Dynamic Output. Array of report IDs on level 1 |
| Output | ReportIDLevel2 | Integer | No | Dynamic Output. Array of report IDs on level 2 |
...
- The same processing is performed for the following inputs: 
...
- ResourceType 
- ResourceClassID 
- Group - to get the packaging instructions IDs for all the products that belong to the Group, this input needs to be provided together with GroupType and GroupClassID 
- WorkCenter 
- Department 
