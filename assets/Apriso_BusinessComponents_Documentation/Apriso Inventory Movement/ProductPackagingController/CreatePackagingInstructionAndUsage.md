# CreatePackagingInstructionAndUsage
...
- Validity dates of the PI are not setup. 
- Dimensions of the PI are not setup. 
...
| Input | PackagingInstructionUsageType | Integer | No | Packaging instruction usage type to populate packaging instruction usage. Optional. |
