...
The purpose of this business component method is to create a request for a specific
 resource class in the wip_req_resource.
...
| Input | ResourceClassID | Integer | Yes | Resource class being requested |
...
- System validates Resource Class based on ResourceClassId 
