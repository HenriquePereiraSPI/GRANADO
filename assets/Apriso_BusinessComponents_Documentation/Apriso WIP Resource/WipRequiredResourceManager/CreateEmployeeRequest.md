...
| Input | StepSequenceNo | Integer | Yes | Operation Step for which the request will be created. |
| Input | EmployeeNo | Char | No | Employee being requested |
...
- System validates Resource based on EmployeeNo. 
