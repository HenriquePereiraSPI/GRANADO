...
The purpose of this Business Component is to explode the given work order with the specified process. Unlike other explosion methods, the user supplies the process that should be used to explode the work order.
...
| Input | processID | Integer | Yes | Process. |
