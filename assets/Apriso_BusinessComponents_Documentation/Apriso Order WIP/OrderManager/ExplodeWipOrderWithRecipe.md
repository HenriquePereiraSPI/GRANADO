...
The purpose of this Business Component is to Explodes the given work order with the specified recipe. Unlike other explosion methods, this method requires the user to supply the recipe to explode the work order with.
...
| Input | processID | Integer | No | Process |
| Input | recipeID | Integer | No | Recipe |

## Validations

- Work order exists 
- Recipe exists  
-  If wip order is cancelled.
