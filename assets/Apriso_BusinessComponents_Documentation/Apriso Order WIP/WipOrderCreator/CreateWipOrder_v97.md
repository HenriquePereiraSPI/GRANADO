...
| Input | ExpectedDurationSeconds | Integer | No | The expected duration of the WIP Order in seconds (local time). |
| Input | ScheduledDurationSeconds | Integer | Yes | The scheduled duration of the WIP Order in seconds. |
...
| Input | ParentOprSequenceNo | Char | No | The parent Operation Sequence number that represents the WIP Operation (optional). If specified, it must exist in the system. |
...
- System validates that the DateTime inputs are between 1st January 1905 and 31st December 2135.
...
- System updates Genealogy if ParentWipOrder is provided.  
...
|  | PrimaryLotNo | False |
| WIP_ORDER_RELATION | ParentWIPOrderNo | Selected from the database based on ParentWipOrderNo and ParentWipOrderType. |
|  | ParentWIPOrderType | Selected from the database based on ParentWipOrderNo and ParentWipOrderType. |
|  | ChildWIPOrderNo | Selected from the database based on ParentWipOrderNo and ParentWipOrderType. |
|  | ChildWIPOrderType | Selected from the database based on ParentWipOrderNo and ParentWipOrderType. |
|  | ParentChildRatio | Selected from the database based on ParentWipOrderNo and ParentWipOrderType. |
|  | ChildOrderQuantity | Selected from the database based on ParentWipOrderNo and ParentWipOrderType. |
|  | ChildOrderQuantityUOM | Selected from the database based on ParentWipOrderNo and ParentWipOrderType. |
