...
The purpose of this method is to get information about a business entity assigned to specific hexadecimal code.

## Parameters

| IO | Name | Type | Required | Description |
|----|------|------|----------|-------------|
| Input | hexCode | Char | Yes | Hexadecimal code to retrieve info about. |
...
- System gets information only if SerialNumber is specified in the code.
