...
The purpose of this method is to associate bit code to a business entity.

## Parameters

| IO | Name | Type | Required | Description |
|----|------|------|----------|-------------|
| Input | bitCode | Char | Yes | Bit code to associate with business entity. |
...
- System parses input bit code. 
- System creates association to a business entity depending on the entity type.
