...
This Business Component method returns the facility associated with the tag.
...
| Output | Facility | Char | No | Facility or empty when the tag is not linked with any Facility. |
