# AllocateInventory2ByProperties_v2
...
The difference between the aggregated and the full mode is visible only for such Container actions as allocate, deallocate, decrease and move with child containers. BC AllocateInventory2ByProperties_v2 allocates only specified Container (if provided) with no impact on subcontainers. 
