# DeallocateInventory2ByInventoryID
...
| OperationCode | Char | The DFC code for the transaction history. |
| OperationRevision | Char | The DFC revision for the transaction history. |
...
- OperationCode is specified and non-empty (if OperationRevision is specified and non-empty) 
