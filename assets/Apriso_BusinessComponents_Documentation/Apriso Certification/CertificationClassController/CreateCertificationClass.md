...
Creates a CERTIFICATION_CLASS record.

## Parameters

| IO | Name | Type | Required | Description |
|----|------|------|----------|-------------|
| Input | Name | Char | Yes | Certification class name. |
| Output | CertificationClassID | Integer | Yes | ID of the certification class. |
...
- Validation fails if Name already exists for another entry in CERTIFICATION_CLASS. 
- Validation fails if Short, Medium, and Extended description are being provided and exceed the allowed limits.

## System Processing

- System validates that Name is not empty and is unique compared to CERTIFICATION_CLASS. 
...
- System creates a CERTIFICATION_CLASS record. 
- System returns the ID of the newly created CERTIFICATION_CLASS record.

## Published Events

Certification class is created.

## Impacted Tables

| Table | Field | BC Param |
|-------|-------|----------|
| CERTIFICATION_CLASS | Name | Name |
