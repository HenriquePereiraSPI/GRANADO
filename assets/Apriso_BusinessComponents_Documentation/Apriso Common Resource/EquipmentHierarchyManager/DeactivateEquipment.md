...
This Business Component method is used to deactivate Equipment. Maintenance Procedures of Equipment can be set to Disabled and Maintenance Orders that are not started can be cancelled. Child Equipment entities are not deactivated (to deactivate Equipment and its child entities, please use DeactivateEquipmentHierarchy Business Component methos).
...
| WIP_Order | WorkOrderStatus | Set to 5 (cancelled). |
