...
| Input | WipOrderTypeList | Short | No | List of WIP order types of the WIP order to which this item refers. |
...
| Input | OrderTypeList | Short | No | List of order types of the reference order. |
