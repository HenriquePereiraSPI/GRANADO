...
**Status:** Active
**Keywords:** StopProduct_Lite, Stop, Product, StopProduct, ProductLite, LiteLabor, Labor

## Description

Closes a LITE_LABOR record referencing a PRODUCT record.
...
- The LITE_LABOR record's LaborType is not product.
...
Pre-Condition: A LITE_LABOR record exists with LaborStatus set to open and LaborType set to product.

## History Recording in Production

- TRANSACTION_HISTORY- Transaction Name: FlexNet.BusinessFacade.LiteLabor.LiteLaborManager.StopProductLite 
