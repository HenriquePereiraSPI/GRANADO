...
**Status:** Active
**Keywords:** StopWorkCenter_Lite, Stop, Work, Center, WorkCenter, StopWorkCenter, WorkCenterLite, LiteLabor, Labor

## Description

Closes a LITE_LABOR record referencing a WORK_CENTER record.
...
- The ActivityTime is not later than the LITE_LABOR record's StartTime. ActivityTime is converted to UTC and then compared to StartTime. 
- The LITE_LABOR record's LaborStatus is not open. 
- The LITE_LABOR record's LaborType is not work center.
...
Pre-Condition: A LITE_LABOR record exists with LaborStatus set to open and LaborType set to work center.

## History Recording in Production

- TRANSACTION_HISTORY- Transaction Name: FlexNet.BusinessFacade.LiteLabor.LiteLaborManager.StopWorkCenterLite 
