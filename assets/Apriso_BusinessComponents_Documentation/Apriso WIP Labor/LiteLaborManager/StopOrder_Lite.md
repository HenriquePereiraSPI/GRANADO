...
**Status:** Active
**Keywords:** StopOrderLite, Stop, Order, Lite, StopOrder, LiteLabor, Labor

## Description

Closes a LITE_LABOR record referencing a WIP_ORDER record.
...
- The LITE_LABOR record's LaborType is not direct.
...
Pre-Condition: A LITE_LABOR record exists with LaborStatus set to open and LaborType set to direct.

## History Recording in Production

- TRANSACTION_HISTORY- Transaction Name: FlexNet.BusinessFacade.LiteLabor.LiteLaborManager.StopOrderLite 
