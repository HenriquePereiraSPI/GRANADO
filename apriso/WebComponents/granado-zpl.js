...
if (!customElements.get('granado-zpl')) {
  ...
  class GranadoZpl extends HTMLElement {
    ...
    _render() {
      ...
      else if (type === 'pesagem-gaiola') inner = this._renderPesagemGaiola(this.data || {});
      else if (type === 'default') inner = this._renderDefault(this.data || {});
      else if (type === 'reidentificacao') inner = this._renderReidentificacao(this.data || {});
    ...
    _renderPesagemGaiola(d) {
      ...
      // SECTION 2 — Ordem de Fabricacao / Gaiola
      const sec2 =
        `<div style="display:flex">` +
      ...
      // SECTION 3 — Granel resultante / No da etiqueta
      const sec3 =
        `<div style="display:flex">` +
      ...
      // SECTION 4 — Lote / Usuario / Matricula / No da gaiola
      const sec4 =
        `<div style="display:flex">` +
