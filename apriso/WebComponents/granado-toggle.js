...
/* __granado_guard__ */
if (!customElements.get('granado-toggle')) {
  class GranadoToggle extends HTMLElement {
    ...
    _build() {
      ...
      this.innerHTML = `<span data-toggle-root role="switch" tabindex="0" style="display:inline-flex;align-items:center;gap:10px;cursor:pointer;user-select:none;font-family:'Poppins','DejaVu Sans',Arial,sans-serif;font-size:13px;outline:none;line-height:1">${order}</span>`;
  ...
  window.GranadoToggle = GranadoToggle;
}
