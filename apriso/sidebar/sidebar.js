(function () {
    function init() {
        ...
        //    Prioridade: {ActiveMenu} (Portal Session Variable, source of
        //    truth para Change View) > {Screen} (fallback para
        //    navegacao inter-Screen quando ActiveMenu ainda nao foi setada).
        // ============================================================
        var activeKey = activeMenu || currentScreen;
        ...
        sidebar.addEventListener('click', function (e) {
            var item = e.target.closest('.sb-sub-item[data-flx-bind="Action"]');
            if (!item) return;
